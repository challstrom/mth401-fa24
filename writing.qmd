...
* It is clearly written using complete sentences. In particular, all mathematical notation and expressions should be part of a sentence.
...
* It is written at a level that is appropriate for a MATH 401 audience, namely, members of our class who are familiar with
...
* Your proofs should begin with “Proof:” (without the quotation marks) and end in a way that indicates to your reader that they have reached the end, e.g. with an appropriate symbol, such as $\square$.
* The proof is correct and the steps in the proof are also correct.
* The proof is complete, meaning that a member of the standard Math 401 audience (see above) can trace your reasoning
